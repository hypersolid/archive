    ...
    <form method="post" name="Auth" action="<?php echo $RootAdmin.$_REQUEST['action'];?>">
      <table width="100%" height="100%" cellpadding="0" cellspacing="0" valign="top">
        ...
        <tr>
          <td></td>
          <td>
            <table valign="top" align="center" class="AuthMTable" width="522" height="10" cellpadding="0" cellspacing="0">
              <tr>
                <td>
                  <table CLASS="blues"  valign="top" width="380" height="10" align="center" valign="center" cellpadding="0" cellspacing="0">
                    <!--authentification-->
                    <tr>
                      <td colspan="2" align="center" >
		      <b>Пожалуйста введите логин и пароль редактора.</b>
...
<br>
				<input type="button" onclick="javascript:Checker();" align="center"  value="Войти" style="width:300px ">
                      </td>
                    </tr>
					<tr height="5">
					</tr><!--/authentification-->
