...
function AdminCheck($login,$password)
{
	...
	if (empty($Info))
	{
		echo '<script language="javascript">alert(\'Неверный логин\');</script>';
	}
	...
	else
	{
		...
		{
		echo '<script language="javascript">alert(\'Неверный пароль\');</script>';
		}
		else
		{
